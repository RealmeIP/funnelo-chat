...
public class SignatureM {
	...
	// Ctor.
	public SignatureM(DHPublicKey localPubKey, DHPublicKey remotePublicKey, PublicKey localLongTermPublicKey,
			int keyPairID) {
	...
	public boolean equals(Object obj) {
		...
		} else if (!localLongTermPubKey.equals(other.localLongTermPubKey)) return false;
		if (localPubKey == null) {
			if (other.localPubKey != null) return false;
		} else if (!localPubKey.equals(other.localPubKey)) return false;
		if (remotePubKey == null) {
			if (other.remotePubKey != null) return false;
		} else if (!remotePubKey.equals(other.remotePubKey)) return false;
		return true;
	}
