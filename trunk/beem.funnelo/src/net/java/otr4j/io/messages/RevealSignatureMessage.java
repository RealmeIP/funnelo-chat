...
public class RevealSignatureMessage extends SignatureMessage {
	...
	// Ctor.
	public RevealSignatureMessage(int protocolVersion, byte[] xEncrypted, byte[] xEncryptedMAC, byte[] revealedKey) {
	...
	public boolean equals(Object obj) {
		...
		if (!Arrays.equals(revealedKey, other.revealedKey)) return false;
		return true;
	}
}
