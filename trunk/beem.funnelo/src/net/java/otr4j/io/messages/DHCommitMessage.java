...
public class DHCommitMessage extends AbstractEncodedMessage {
	...
	// Ctor.
	public DHCommitMessage(int protocolVersion, byte[] dhPublicKeyHash, byte[] dhPublicKeyEncrypted) {
	...
	public boolean equals(Object obj) {
		...
		if (!Arrays.equals(dhPublicKeyHash, other.dhPublicKeyHash)) return false;
		return true;
	}
